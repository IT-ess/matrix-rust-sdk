...
use crate::{
    OpStamp,
    bookmarks::schema::{BookmarkSchema, MatrixBookmarkIndexSchema},
    error::IndexError,
};

pub(crate) struct BookmarkIndexWriter {
    inner: IndexWriter,
    last_commit_opstamp: OpStamp,
    schema: BookmarkSchema,
}

impl BookmarkIndexWriter {
    pub(crate) fn new(writer: IndexWriter, schema: BookmarkSchema) -> Self {
